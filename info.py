...
BOT_TOKEN = environ.get('BOT_TOKEN', "7541477001:AAHfoivwu4W1bFmK1mFbk1z6VWvwFp8odag")
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shiv:shiv99@cluster0.bew71ug.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # mongodb+srv://BoB:Mishraji99@cluster0.v99uneo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://BoB:Mishraji99@cluster0.v99uneo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #mongodb+srv://shiv:shiv99@cluster0.bew71ug.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", " -1002077157127") # add multiple channels here, separated by single space
AUTH_CHANNEL = [int(ch) for ch in AUTH_CHANNEL.strip().split()] if AUTH_CHANNEL else []
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002384821467') # add multiple channels here, separated by single space
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/bob_files1') 
